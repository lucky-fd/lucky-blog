package com.fd.luckyblog.commons.feign;

import com.fd.luckyblog.commons.config.feign.FeignConfiguration;
import com.fd.luckyblog.commons.fallback.SearchFeignFallback;
 ...
 */
@FeignClient(name = "lucky-blog-search", contextId = "searchFeignClient", configuration = FeignConfiguration.class, fallback = SearchFeignFallback.class)
