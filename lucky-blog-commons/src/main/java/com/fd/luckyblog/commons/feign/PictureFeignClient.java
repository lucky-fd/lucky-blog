...
import com.fd.luckyblog.commons.fallback.PictureFeignFallback;
 ...
 * @author 陌溪
 */
@FeignClient(name = "lucky-blog-file", configuration = FeignConfiguration.class, fallback = PictureFeignFallback.class)
