package com.fd.luckyblog.gateway.filter;
...
/*    @Autowired
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        addHeader(mutate, SecurityConstants.NICK_NAME, nickName);
        addHeader(mutate, SecurityConstants.LOG_ID, SnowFlakeUtil.getStrId());
        addHeader(mutate,SecurityConstants.IP_ADDR, IpUtils.getIpAddr(request));
        // 内部请求来源参数清除
